 ...
 *
 * This is needed when Stoic attaches via JVMTI and doesn't have a Context readily available.
 * Uses ActivityThread.currentApplication() which is available in all Android versions.
 *
